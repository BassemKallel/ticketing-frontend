                ...
                <div className="flex flex-col items-center justify-center px-6 py-8 mx-auto md:h-screen lg:py-0">
                    ...
                    <div className="w-full bg-white rounded-lg shadow-md md:mt-0 sm:max-w-md xl:p-0 hover:shadow-lg transition-shadow duration-300">
                        <div className="p-6 space-y-4 md:space-y-6 sm:p-8">
                            ...
                            <form className="space-y-4 md:space-y-6 max-h-full overflow-hidden" action="#" >
                                <div>
                                    <label
                                        htmlFor="name"
                                ...
                                <button
                                    type="submit"
                                    className="w-full text-white bg-[#F28C38] hover:bg-[#FFE4B5] focus:ring-4 focus:outline-none focus:ring-[#F4C430] font-medium rounded-lg text-sm px-5 py-2.5 text-center transition-colors duration-300"
                                >
                                    Sign up
                                </button>
